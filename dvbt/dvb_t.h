...
void dvb_t_final_modulate(fftw_complex *in, int length, int guard);
void dvb_t_final_modulate(fftw_complex *in, float *taper, int length, int guard);
void dvb_t_clip(fftw_complex *in, int length);
void dvb_t_modulate_init(void);
