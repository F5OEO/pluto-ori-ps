...
pluto_stream: pluto_stream.cpp mymqtt.h mqtthandlestream.h mqtthandlestream.cpp iiofshelper.cpp dvbs2neon/dvbs2neon0v43.S tsinputmux.cpp tsinputmux.h gsemux.cpp gsemux.h iqtofft.h iqtofft.cpp ts_util/sdt.cpp ts_util/pcrpts.c
	$(CXX) $(INC) $(FLAGS) -DCOMIT_FW=\"$(VER)\" -o pluto_stream gsemux.cpp dvbs2neon/dvbs2neon0v43.S ts_util/sdt.cpp ts_util/pcrpts.c pluto_stream.cpp mqtthandlestream.cpp iiofshelper.cpp tsinputmux.cpp iqtofft.cpp -lm -lrt -lpthread -lmosquitto -ljansson -lgse	-lNE10 -lcivetweb
install: 
