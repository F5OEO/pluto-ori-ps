...
all: pluto_mqtt_ctrl pluto_stream iio_proxy iio_ws_proxy
...
iio_proxy: iio_proxy.c
	$(TOOLS_PATH) $(CC) -O2 iio_proxy.c -o iio_proxy -lpthread
...
clean:
	rm -f  pluto_mqtt_ctrl pluto_stream iio_proxy iio_ws_proxy
