...
void on_connect(struct mosquitto *mosq, void *obj, int reason_code)
{
	...
	rc = mosquitto_subscribe(mosq, NULL, "plutodvb/#", 1);
	rc = mosquitto_subscribe(mosq, NULL, "cmd/pluto/#", 1);
	rc = mosquitto_subscribe(mosq, NULL, "dt/pluto/#", 1);
